...
public class ResultHighlighter {
	...
	public String[] getHighlightedText(Document document, String field) throws IOException, InvalidTokenOffsetsException {
										
		// Create token stream.
		TokenStream stream = TokenSources.getTokenStream(field, null, document.get(field), new StandardAnalyzer(), highlighter.getMaxDocCharsToAnalyze() - 1);
